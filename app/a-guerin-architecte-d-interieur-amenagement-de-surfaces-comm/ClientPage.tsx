...
/* ─── Template Variables ─── */
const BUSINESS_NAME = "A.GUERIN Architecte d'interieur aménagement de surfaces commerciales";
const CITY = "Caen";
const PHONE_NUMBER = "06 64 99 84 19";
const PHONE_CLEAN = "+33664998419";
const WHATSAPP_LINK = "https://wa.me/33664998419";
const NICHE_LABEL = "Architecte D'intérieur";
const ADDRESS = "Espace conquerant, 3 Pl. Jean Nouzille, 14000 Caen, France";
