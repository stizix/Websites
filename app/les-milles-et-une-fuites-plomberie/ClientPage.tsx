...
/* ─── Template Variables ─── */
const BUSINESS_NAME = "Les milles et une fuites plomberie";
const CITY = "Tours";
const PHONE_NUMBER = "06 12 21 06 57";
const PHONE_CLEAN = "+33612210657";
const WHATSAPP_LINK = "https://wa.me/33612210657";
const NICHE_LABEL = "Plombier";
const ADDRESS = "70 Rue Marceau, 37000 Tours, France";
