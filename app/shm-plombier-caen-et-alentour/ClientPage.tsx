...
/* ─── Template Variables ─── */
const BUSINESS_NAME = "SHM PLOMBIER CAEN ET ALENTOUR";
const CITY = "Falaise";
const PHONE_NUMBER = "07 58 39 58 84";
const PHONE_CLEAN = "+33758395884";
const WHATSAPP_LINK = "https://wa.me/33758395884";
const NICHE_LABEL = "Plombier";
const ADDRESS = "5 Rue Robert le Magnifique, 14700 Falaise, France";
...
const NICHE_IMAGES: Record<string, { hero: string; gallery: string[] }> = {
  ...
  plombier: {
    ...
    gallery: [
      ...
      "https://images.unsplash.com/photo-1564540586988-aa4e53ab3394?w=800&q=80&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1613685703305-0e8793544b37?w=800&q=80&auto=format&fit=crop",
  ...
  menuisier: {
    hero: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=1920&q=80&auto=format&fit=crop",
    gallery: [
      "https://images.unsplash.com/photo-1616627577385-5c0c4dab55a5?w=800&q=80&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1588854337236-6889d631faa8?w=800&q=80&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1597003705920-36aeb886c4e6?w=800&q=80&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80&auto=format&fit=crop",
  ...
  jardinier: {
    ...
    gallery: [
      ...
      "https://images.unsplash.com/photo-1598902108854-d1446413a833?w=800&q=80&auto=format&fit=crop",
