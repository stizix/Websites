...
/* ─── Template Variables ─── */
const BUSINESS_NAME = "Services génie climatique";
const CITY = "Caen";
const PHONE_NUMBER = "07 83 02 21 92";
const PHONE_CLEAN = "+33783022192";
const WHATSAPP_LINK = "https://wa.me/33783022192";
const NICHE_LABEL = "Plombier";
const ADDRESS = "73 Rue du Général Moulin, 14000 Caen, France";
