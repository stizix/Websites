...
/* ─── Template Variables ─── */
const BUSINESS_NAME = "Martin Thierry";
const CITY = "Le Havre";
const PHONE_NUMBER = "06 13 50 34 17";
const PHONE_CLEAN = "+33613503417";
const WHATSAPP_LINK = "https://wa.me/33613503417";
const NICHE_LABEL = "Architecte D'intérieur";
const ADDRESS = "74 Rue Bernardin de Saint-Pierre, 76600 Le Havre, France";
