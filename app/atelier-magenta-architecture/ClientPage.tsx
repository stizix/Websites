...
/* ─── Template Variables ─── */
const BUSINESS_NAME = "Atelier Magenta Architecture";
const CITY = "Le Havre";
const PHONE_NUMBER = "06 73 07 67 13";
const PHONE_CLEAN = "+33673076713";
const WHATSAPP_LINK = "https://wa.me/33673076713";
const NICHE_LABEL = "Architecte D'intérieur";
const ADDRESS = "107 Rue Gabriel Péri, 76600 Le Havre, France";
